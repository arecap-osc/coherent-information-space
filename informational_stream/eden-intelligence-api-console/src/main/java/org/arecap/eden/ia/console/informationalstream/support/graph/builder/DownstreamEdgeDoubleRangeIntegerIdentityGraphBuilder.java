...
import org.arecap.eden.ia.console.informationalstream.support.graph.DownstreamEdgeDoubleRangeIntegerIdentityGraph;

import java.util.Optional;

public class DownstreamEdgeDoubleRangeIntegerIdentityGraphBuilder implements InformationalStreamDoubleRangeIntegerIdentityNettingGraphBuilder {

    @Override
    public boolean accept(InformationalStreamNetting netting) {
        return netting.equals(InformationalStreamNetting.DownstreamEdge);
    }
    ...
    public Optional<InformationalStreamDoubleRangeIntegerIdentityGraphBean> getStepDimensionGraph(Double streamDistance, Integer step, Double scale) {
        return Optional.of(new DownstreamEdgeDoubleRangeIntegerIdentityGraph(streamDistance, step, scale));
    }

    @Override
    public ComplexPlane getScroll(InformationalStreamDoubleRangeIntegerIdentityGraphBean root) {
        return new ComplexPlane( 3D/4D * root.getWidth() * root.getScale(),1D/2D * root.getHeight() * root.getScale());
    }
    ...
    public Optional<InformationalStreamDoubleRangeIntegerIdentityGraphBean> getSelectorFunctionGraph(InformationalStreamDoubleRangeIntegerIdentityGraphBean root, ComplexPlanePropertiesFactory<Double> origin, ComplexPlanePropertiesFactory<Double> graphPosition) {
        DownstreamEdgeDoubleRangeIntegerIdentityGraph result = new DownstreamEdgeDoubleRangeIntegerIdentityGraph(root.getStreamDistance(), root.getStep(), root.getScale());
        result.setRoot(root);
