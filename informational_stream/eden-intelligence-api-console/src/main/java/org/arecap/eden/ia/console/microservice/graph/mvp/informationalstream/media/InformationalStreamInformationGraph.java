...
//                if(sgraph.getId() < 0) {
                    graphics2D.setColor(sgraph.getVectorDirection().equals(InformationalStreamVectorDirection.SelectorConsumer) ? ColorFactory.RED : ColorFactory.BLUE);
                    ...
                    graphics2D.setColor(sgraph.getVectorDirection().equals(InformationalStreamVectorDirection.SelectorConsumer) ? ColorFactory.web("#DE711F") : ColorFactory.web("#1F8CDE"));
                    ...
                    graphics2D.setColor(sgraph.getVectorDirection().equals(InformationalStreamVectorDirection.SelectorConsumer) ? ColorFactory.web("#DE1FCC") : ColorFactory.web("#1FDE31"));
