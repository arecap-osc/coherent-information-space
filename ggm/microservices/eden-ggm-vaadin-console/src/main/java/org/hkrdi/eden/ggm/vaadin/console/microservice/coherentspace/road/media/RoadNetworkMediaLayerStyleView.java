...
@SpringComponent
@UIScope
public class RoadNetworkMediaLayerStyleView extends NetworkMediaLayerStyleView {

    @Autowired
    private RoadNetworkMediaLayerStylePresenter presenter;

    @Autowired
    private RoadNetworkMediaRendererLayerStyleView mediaRendererLayerStyleView;
