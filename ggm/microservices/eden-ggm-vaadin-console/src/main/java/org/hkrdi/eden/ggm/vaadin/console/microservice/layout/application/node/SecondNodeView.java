...
@SpringComponent
@UIScope
public class SecondNodeView extends AbstractNodeView {
    ...
    @Autowired
    private SecondNodePresenter presenter;

    @Override
    public SecondNodePresenter getPresenter() {
        return presenter;
    }
    ...
    protected void handleNodeTextValueChange() {
        if(getPresenter().getInitialEntityId() != null && getPresenter().getApplicationDataIe().getSyntaxId() != null &&
                ((Long)getPresenter().getInitialEntityId())
