...
public class ImageComposer {
    ...
    private MediaRendererTransform mediaRendererTransform = new SimpleMediaRendererTransform();
    ...
    public List<Image> getImages(MediaRenderLayerFactory mediaRenderLayerFactory, MediaRendererTransform mediaRendererTransform, Boolean forceRefresh) {
        ...
        if (forceRefresh) {
            ...
            imagesMap.clear();
            ((SimpleMediaRendererTransform) this.mediaRendererTransform).config(mediaRendererTransform);
        }
