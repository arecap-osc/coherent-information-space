...
public class RoadFractoloniRoadOptionalPaneView extends RoadOptionalPaneView {
    private static final Logger LOGGER = LoggerFactory.getLogger(RoadFractoloniRoadOptionalPaneView.class);

    @Autowired
    private RoadFractoloniRoadOptionalPanePresenter presenter;
...
//    	getStyle().set("overflow", "auto");
        ...
        verticalPhrase.add(getNode1SemanticLabel(), getNode1Node2SyntaxLabel(), getNode2SemanticLabel());
//        verticalPhrase.setHeight("250px");
...
//        setHeight("100%");
	...
	@Override
    public RoadFractoloniRoadOptionalPanePresenter getPresenter() {
        return presenter;
    }
