...
@SpringComponent
@UIScope
public class FromMapLinkPresenter  extends DefaultFlowEntityPresenter<MapLink, Long> {
    private static final Logger LOGGER = LoggerFactory.getLogger(FromMapLinkPresenter.class);
    ...
    public Long getInitialEntityId() {
        return semanticMapIe.getFirstMapLinkId();
    }
