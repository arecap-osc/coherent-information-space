...
public class HexavalentEdgesNonAnimatedMediaLayer implements PNGMediaRendererDrawer, NetworkMediaLayerName, MediaRenderStyleAware {
	...
	public HexavalentEdgesNonAnimatedMediaLayer() {
		super();
	}

	public HexavalentEdgesNonAnimatedMediaLayer(String network) {
		super();
		setNetwork(network);
	}
	...
	public void drawContent(Graphics2D graphics2d, MediaRendererTransform mrt) {
		CoherentSpaceGraphics2DUtils.drawLines(graphics2d, outerEdges, mrt, graphics2dStyle);
	}
